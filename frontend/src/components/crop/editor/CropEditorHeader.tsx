  ...
  return (
    <div className="relative px-5 sm:px-6 py-4 border-b border-white/5 bg-gradient-to-r from-neutral-950 via-neutral-950/95 to-purple-950/20">
      ...
      <div className="grid gap-4 xl:grid-cols-[minmax(0,1fr)_auto_auto] xl:items-center">
        ...
        <div className="w-full xl:w-auto flex items-center justify-between gap-2 bg-neutral-900/70 ring-1 ring-white/10 shadow-[0_10px_30px_rgba(15,23,42,0.35)] rounded-3xl p-1.5 select-none">
          <button
        ...
        <div className="w-full xl:w-auto flex flex-wrap items-center gap-2 justify-end xl:justify-end">
          <button
            type="button"
            onClick={handleUndo}
