...
export function AutoCropParameterSlider({ label, value, min, max, step = 1, onChange, hint, unit = "" }: Props) {
  ...
  return (
    <div className={cardClass}>
      <div className={labelClass}>
        <span className="text-neutral-500 uppercase tracking-wider font-bold">{label}</span>
